...
export default function RecentEvents() {
  ...
  return (
    <div className="w-full max-w-md p-4 bg-white border border-gray-200 rounded-lg shadow-xl sm:p-8 text-[#5E5873] basis-1/2 mb-5">
    <div className="flex items-center justify-between mb-4">
        <h5 className="text-xl font-bold leading-none text-[#5E5873]">What's New!</h5>
